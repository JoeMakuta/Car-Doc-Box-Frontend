...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    ...
    <body className={` grid grid-cols-[80px_1fr]  grid-rows-[80px_1fr] `}>
      <header className=" flex w-full justify-between p-3 items-center border-b-[1px] border-black/10 ">
      ...
      <main className=" flex border-l-[1px] border-main_color/20 p-4 ">
        {children}
      </main>
    </body>
    // </ConfigProvider>
