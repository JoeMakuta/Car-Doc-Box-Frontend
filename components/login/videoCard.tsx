...
const VideoCard = () => {
  return (
    <div className=" flex w-[70%] z-10 min-w-fit absolute right-1/3  rounded-xl justify-center gap-3 cursor-pointer  transition-all delay-200 text-white items-center p-3 bg-main_color ">
